...
Alle Modelle, die für die Attacken oder die weiterführenden Analysen im Anhang, verwendet wurden befinden sich im Ordner *models*. Mit Außnahme des *Nearest Neighbors* und *QDA* Modell für das *Chatbot*-Szenario, welche aufgrund der Dateigröße nicht hochgeladen werden konnten. Diese Modelle können über das *Chatbot_AnhKlass_Train* Skript erstellt werden.Das Training aller Modelle geschah durch die Skripte mit dem Suffix *Train*.\
